...
/// Returns the name of the index.md file for a [`manifest::TomlPackage`].
fn normalize_package_readme(
    ...
    match &readme {
        ...
        Some(value) => match value {
            ...
            manifest::StringOrBool::Bool(true) => Some("index.md.md".to_string()),
            manifest::StringOrBool::String(v) => Some(v.clone()),
        },
    }
}

pub const DEFAULT_README_FILES: [&str; 3] = ["index.md.md", "index.md.txt", "index.md"];

/// Checks if a file with any of the default index.md file names exists in the package root.
